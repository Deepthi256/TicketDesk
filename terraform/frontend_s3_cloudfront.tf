# S3 Bucket for Frontend (Non-public)
resource "random_id" "bucket_suffix" {
  byte_length = 4
}

resource "aws_s3_bucket" "frontend" {
  bucket        = "${var.resource_prefix}-frontend-${random_id.bucket_suffix.hex}"
  force_destroy = true
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # Default behavior routes static assets to S3
